...
(function (Project_1) {
    ...
    (function (Issues_1) {
        class Issues {
            ...
            async post(body) {
                let url = '';
                let urlQueryParams = [];
                url = `/org/${Object(this.currentContext)['orgId']}/project/${Object(this.currentContext)['projectId']}/issues`;
                if (urlQueryParams.length > 0) {
                    url += `?${urlQueryParams.join('&')}`;
                }
                try {
    ...
    })(Issues = Project_1.Issues || (Project_1.Issues = {}));
...
(function (Dependencies_1) {
    class Dependencies {
        ...
        async postAll(noLimitMode = false, body, sortBy, order) {
            let url = '';
            let urlQueryParams = [];
            url = `/org/${Object(this.currentContext)['orgId']}/dependencies`;
            if (sortBy) {
...
(function (Audit_1) {
    class Audit {
        ...
        async postAll(noLimitMode = false, body, from, to, sortOrder) {
            let url = '';
            let urlQueryParams = [];
            url = `/org/${Object(this.currentContext)['orgId']}/audit`;
            if (from) {
