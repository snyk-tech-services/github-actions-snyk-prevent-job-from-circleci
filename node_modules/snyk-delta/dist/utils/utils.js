...
exports.getPipedDataIn = exports.getDebugModule = exports.init = exports.displaySplash = void 0;
...
exports.getDebugModule = getDebugModule;
...
exports.displaySplash = displaySplash;
    ...
    return new Promise((resolve, reject) => {
        ...
        try {
            ...
            if (process.stdin.isTTY) {
                throw new inputError_1.BadInputError('No input data detected. Check out the --help option');
            }
        }
        catch (err) {
            reject(err);
...
exports.getPipedDataIn = getPipedDataIn;
